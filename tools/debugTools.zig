...
pub fn draw(x: i32, y: i32, tris_drawn: i32) void {
    ...
    const box_h: i32 = (line_height * 6) + padding * 2;
    ...
    current_y += line_height;
    rl.drawText(line5, x + padding, current_y, font_size, rl.Color.ray_white);
    current_y += line_height;
    rl.drawText(line6, x + padding, current_y, font_size, rl.Color.gray);
}
