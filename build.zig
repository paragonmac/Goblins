...
pub fn build(b: *std.Build) void {
    ...
    const mod = b.addModule("Goblinoria", .{
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "Goblinoria" is the name you will use in your source code to
                // import this module (e.g. `@import("Goblinoria")`). The name is
    ...
    exe.root_module.linkLibrary(raylib_zig_dep.artifact("raylib"));
